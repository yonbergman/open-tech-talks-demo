...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { duration: @talk.duration, person: @talk.person, room: @talk.room, starts_at: @talk.starts_at, title: @talk.title }
    end
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { duration: @talk.duration, person: @talk.person, room: @talk.room, starts_at: @talk.starts_at, title: @talk.title }
    assert_redirected_to talk_path(assigns(:talk))
  end
